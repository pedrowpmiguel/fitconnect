...
const RegisterTrainer = () => {
    ...
    // Define a data máxima permitida (18 anos)
    ...
    const handleSubmit = async (e) => {
        ...
        if (age < 18) {
            setError('Tem de ter pelo menos 18 anos para se registar como treinador');
            setLoading(false);
            return;
        }
        ...
        <div className="register-page-wrapper">
            <div className="register-container">
                ...
                <form onSubmit={handleSubmit} className="register-form">
                    ...
                    <div className="form-group">
                        <label htmlFor="description">Sobre si:</label>
                        <textarea
                            id="description"
                            name="description"
                            value={formData.description}
                            onChange={handleChange}
                            placeholder="Escreva uma pequena descrição sobre si..."
                            disabled={loading}
                            rows={4}
                        />
                    </div>
